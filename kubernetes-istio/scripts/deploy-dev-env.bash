...
kubectl apply -f kubernetes-istio/services/overlays/dev/rabbitmq-dev.yml
kubectl apply -f kubernetes-istio/services/overlays/dev/mongodb-dev.yml
kubectl apply -f kubernetes-istio/services/overlays/dev/mysql-dev.yml
kubectl wait --timeout=600s --for=condition=ready pod --all

# Next deploy the microservices and wait for their pods to become ready
kubectl apply -k kubernetes-istio/services/overlays/dev
